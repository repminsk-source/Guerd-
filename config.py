...
# ─── Модерация: авто-эскалация по варнам ─────────────────────────
# При достижении N варнов автоматически применяется наказание.
# Формат: {количество_варнов: "punishment"}. punishment: "mute" | "kick" | "ban"
WARN_ESCALATION = {
    3: "mute",
    5: "kick",
    7: "ban",
}
WARN_MUTE_DURATION_MIN = 30

# ─── Экономика / мини-игры ────────────────────────────────────────
CURRENCY_NAME = "Aegis-коины"
CURRENCY_ICON = "🪙"
DAILY_REWARD = 100
...
SLOTS_MIN_BET = 10
SLOTS_EMOJIS = ["🍒", "🍋", "🍇", "🔔", "💎", "7️⃣"]
SLOTS_PAYOUTS = {  # множитель ставки в зависимости от комбинации
    "7️⃣": 10,
    "💎": 7,
    "🔔": 5,
    "🍇": 3,
