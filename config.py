...
# ─── Ужесточённый режим для только что вошедших ботов ────────────
# В течение NEW_BOT_STRICT_WINDOW секунд после входа бота на сервер
# ему хватит NEW_BOT_STRICT_LIMIT опасных действий (вместо обычного
# лимита из ANTINUKE_LIMITS), чтобы получить мгновенный бан.
# Это главная защита от сценария "владелец сам добавил рейд-бота,
# не зная, что он вредоносный, и тот сразу начал сносить сервер".
NEW_BOT_STRICT_WINDOW = 120           # сек. после входа бот считается "новым"
NEW_BOT_STRICT_LIMIT = 1              # 1 опасное действие = наказание
